...
const WebSocketMessageBubble = ({ message, currentUserID, user }) => {
  ...
  if (message.sender_id === currentUserID && user !== null) {
    return (
      <div className="flex mb-2">
        <div className={`rounded py-1 px-1 bg-[#F2F2F2] ${message.is_read === false && "border-2 border-red-500 border-solid"}`}>
          ...
          <p
            ...
            dir={message.message && contentDisplay(message.message) ? "rtl" : "ltr"}
          >
  ...
  return (
    <div className="flex justify-end mb-2">
      ...
      <div className={`rounded p-1 bg-[#E2F7CB] ${message.is_read === false && "border-2 border-red-500 border-solid"}`}>
