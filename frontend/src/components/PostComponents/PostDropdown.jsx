...
function PostDropdown({ onEdit, onDelete }) {
    ...
    return (
        <div className="relative">
            ...
            >
                <MoreVertical className="size-4 lg:size-8 text-gray-500" />
            </button>
            ...
            {isOpen && (
                <div className="absolute right-0 mt-1 w-52 lg:w-56 bg-white rounded-lg shadow-lg py-1 z-10">
                    <button
                        ...
                        className="w-full px-4 py-2 text-left text-sm text-gray-700 hover:bg-gray-100 flex items-center lg:text-xl"
                    >
                        <Pencil className="size-3 lg:size-6 mr-2" />
                        {t("post.update")}
                    </button>
                    <button
                        onClick={() => {
                        ...
                        className="w-full px-4 py-2 text-left text-sm text-red-600 hover:bg-gray-100 flex items-center lg:text-xl"
                    >
                        <Trash2 className="size-3 lg:size-6 mr-2" />
                        {t("post.deletepost")}
                    </button>
                </div>
            )}
